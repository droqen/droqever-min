...
const Engine = (function () {
  ...
  Engine.load = function (basePath, size) {
    if (loadPromise == null) {
      ...
      loadPromise = preloader.loadPromise(`/wasm/droq-godot.wasm`, size, true); // DROQEN WAS HERE
    ...
    const proto = /** @lends Engine.prototype */ {
      ...
      init: function (basePath) {
        ...
        if (loadPromise == null) {
          ...
          Engine.load(basePath, this.config.fileSizes[`/wasm/droq-godot.wasm`]); // DROQEN WAS HERE
        }
        const me = this;
